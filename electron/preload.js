...
contextBridge.exposeInMainWorld('api', {
  ...
  addTask:         (name, period, tabId, stateCount, professionId, customImage, trackProfit, profitDisplay) => ipcRenderer.invoke('add-task', { name, periodicity: period, tab_id: tabId, state_count: stateCount, profession_id: professionId, custom_image: customImage, track_profit: trackProfit, profit_display: profitDisplay }),
  editTask:        (tid, name, period, stateCount, professionId, customImage, trackProfit, profitDisplay)   => ipcRenderer.invoke('edit-task', { tid, name, periodicity: period, state_count: stateCount, profession_id: professionId, custom_image: customImage, track_profit: trackProfit, profit_display: profitDisplay }),
